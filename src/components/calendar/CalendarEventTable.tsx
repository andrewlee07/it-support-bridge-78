            ...
            >
              ...
              <TableCell>
                <Badge 
                  ...
                  className={
                    event.type === 'change' 
                      ? 'bg-blue-100 dark:bg-blue-900/40 text-blue-800 dark:text-blue-200 hover:bg-blue-200 dark:hover:bg-blue-800/60 border-blue-200 dark:border-blue-800' 
                      : 'bg-purple-100 dark:bg-purple-900/40 text-purple-800 dark:text-purple-200 hover:bg-purple-200 dark:hover:bg-purple-800/60 border-purple-200 dark:border-purple-800'
                  }
                >
                ...
                <Badge 
                  ...
                  className={
                    event.status === 'approved' 
                      ...
                      : 'bg-gray-100 dark:bg-gray-800/40 text-gray-800 dark:text-gray-200 border-gray-200 dark:border-gray-700'
                  }
                >
