...
const ServiceRequestConfiguration = () => {
  const { configurations, isLoading, updateConfiguration } = useModuleConfigurations('service-request');

  return (
    <div className="container mx-auto p-4 space-y-8">
      <h1 className="text-3xl font-bold">Service Request Configuration</h1>
      ...
      <Tabs defaultValue="general" className="w-full">
        ...
        <TabsContent value="general" className="mt-0">
          <Card>
            ...
            <CardContent>
              <p>Configure general service request settings.</p>
            </CardContent>
          </Card>
        </TabsContent>
        ...
        <TabsContent value="sla" className="mt-0">
          <Card>
            ...
            <CardContent>
              <p>Configure SLA settings for service requests.</p>
            </CardContent>
          </Card>
        </TabsContent>
        ...
        <TabsContent value="workflow" className="mt-0">
          <Card>
            ...
            <CardContent>
              <p>Configure workflow settings for service requests.</p>
            </CardContent>
          </Card>
        </TabsContent>
        ...
        <TabsContent value="autoClose" className="mt-0">
          <div className="grid gap-4">
            ...
            <p className="text-muted-foreground">
              Configure when service requests are automatically closed after fulfillment.
            </p>
